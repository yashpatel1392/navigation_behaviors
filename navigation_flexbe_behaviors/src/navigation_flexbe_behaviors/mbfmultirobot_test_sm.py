...
@author: yashp
'''
class MBFMultiRobot_TestSM(Behavior):
	'''
	MBFMultiRobot_Test
	'''
	...
	def __init__(self):
		super(MBFMultiRobot_TestSM, self).__init__()
		self.name = 'MBFMultiRobot_Test'
	...
	def create(self):
		...
		# x:335 y:274, x:608 y:341, x:187 y:404, x:94 y:337, x:430 y:365
