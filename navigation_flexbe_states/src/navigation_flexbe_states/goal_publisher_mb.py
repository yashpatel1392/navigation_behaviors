...
class GoalPublisherMB(EventState):
    ...
    a particular topic (<robot_name>/goal_pose) and the PoseStamped goals list is passed as an 
    output key. 

    -- robot_names   string             robot namespaces.
    -- robot_goals   string             robot goals
    
    #> goals         PoseStamped[]      list of the robot goals as a geometry_msgs::PoseStamped
